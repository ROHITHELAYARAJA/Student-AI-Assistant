...
export function StudyWorkspace() {
  ...
  return <div className={`studio astra-studio ${inStudy?'lesson-mode':'home-mode'} ${conversation.length&&!inStudy?'conversation-mode':''} ${theme==='dark'?'dark':''}`} data-theme={theme}>
