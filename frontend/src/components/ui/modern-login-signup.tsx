...
import { signInWithGoogle, signInWithGitHub, signInWithEmail, signUpWithEmail, isSupabaseConfigured } from '@/services/supabase';
      ...
      <div style={{
        ...
        {isLogin ? (
          <div style={{ width: "100%", maxWidth: 360, display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center" }}>
            ...
            <button type="button" onClick={handleGitHubAuth} style={{ ...socialBtn, marginBottom: 0 }}>
